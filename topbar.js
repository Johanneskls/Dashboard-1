...
// It self-injects HTML + CSS and reads goal progress from the
// same localStorage key the dashboard's Goals tab already uses.
// Only shows tabs that actually exist in this dashboard.
// =============================================================
(function () {
  'use strict';
...
`;
  ...
  // -------- HTML --------
  // Only the Goals pill — the only tab this dashboard actually has.
  const html = `
...
`;
  ...
  // -------- Active-date helper (matches the goals page 6 AM rollover) --------
